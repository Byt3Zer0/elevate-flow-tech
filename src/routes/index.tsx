...
function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative z-10 px-4 pt-20 pb-24 sm:px-6 sm:pt-28 sm:pb-32 lg:px-8 lg:pt-36 lg:pb-40"
    >
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div className="flex flex-col items-start text-left">
          <div
            className={`mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-surface-elevated px-4 py-1.5 text-sm font-medium text-violet-light transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
          >
          ...
          <h1
            className={`font-heading text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl transition-all duration-700 delay-100 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
          >
          ...
          <p
            className={`mt-6 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg md:text-xl transition-all duration-700 delay-200 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
          >
          ...
          <div
            className={`mt-8 flex flex-col gap-4 sm:flex-row sm:items-center transition-all duration-700 delay-300 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
          >
            <a
              href="#contacto"
          ...
          <div
            className={`mt-10 flex items-center gap-4 text-sm text-muted-foreground transition-all duration-700 delay-500 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
          >
        ...
        <div
          className={`relative transition-all duration-1000 delay-200 ${isInView ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-8 scale-95"}`}
        >
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <p
          className={`mb-8 text-center text-sm font-medium uppercase tracking-widest text-muted-foreground transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
        ...
        <div className="grid grid-cols-2 items-center justify-center gap-8 sm:flex sm:flex-wrap sm:gap-12 lg:gap-16">
          {logos.map((logo, i) => (
            <div
              key={logo.name}
              className={`group flex items-center justify-center gap-3 transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
    ...
    <section id="servicios" ref={ref} className="relative z-10 px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 max-w-3xl text-left lg:mb-20">
          <h2
            className={`font-heading text-3xl font-bold tracking-tight text-foreground sm:text-4xl md:text-5xl transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
          >
            Servicios que <span className="text-gradient">multiplican resultados</span>
          </h2>
          <p
            className={`mt-5 text-base text-muted-foreground sm:text-lg transition-all duration-700 delay-100 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
          >
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service, i) => (
            <div
              key={service.title}
              className={`group relative flex flex-col rounded-3xl border border-border bg-surface-elevated p-6 card-glow card-glow sm:p-8 transition-all duration-700 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
    ...
    <section id="beneficios" ref={ref} className="relative z-10 px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 text-center lg:mb-20">
          ...
          <p
            className={`mx-auto mt-5 max-w-2xl text-base text-muted-foreground sm:text-lg transition-all duration-700 delay-100 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
          >
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {benefits.map((benefit, i) => (
            <div
              key={benefit.label}
              className={`relative overflow-hidden rounded-3xl border border-border bg-surface p-8 text-center transition-all duration-700 card-glow card-glow ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
              style={{ transitionDelay: `${150 + i * 120}ms` }}
            >
  ...
  return (
    <section id="contacto" ref={ref} className="relative z-10 px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
      <div className="mx-auto max-w-5xl">
        <div
          className={`relative overflow-hidden rounded-3xl border border-border bg-surface-elevated p-8 text-center shadow-2xl sm:p-12 lg:p-16 transition-all duration-1000 ${isInView ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-8 scale-95"}`}
        >
          {/* Background gradient */}
